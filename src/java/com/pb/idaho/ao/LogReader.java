...
//                System.out.println(this.equals(si));
    ...
    public static String usage() {
        StringBuilder sb = new StringBuilder();
        sb.append("LogReader: Reads ITD log files and creates runtime reports (still beta).\n");
        sb.append("  usage: java -classpath [...] com.pb.idaho.ao.LogReader [log directory] [output directory] (-f)\n");
        sb.append("    where:\n");

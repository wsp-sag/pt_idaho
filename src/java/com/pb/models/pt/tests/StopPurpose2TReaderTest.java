...
import com.pb.models.pt.StopPurpose2TourTableReader;
...
public class StopPurpose2TReaderTest extends TestCase {

    static Logger logger = Logger.getLogger(StopPurpose2TReaderTest.class);
    
    private StopPurpose2TourTableReader freqTable;

    public StopPurpose2TReaderTest() {
        ResourceBundle rb = ResourceUtil.getResourceBundle("pt");
        freqTable = new StopPurpose2TourTableReader(rb);
    }
